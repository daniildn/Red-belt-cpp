...
void TestConstruction() {
  StackVector<int, 32ul> ul;
  ASSERT_EQUAL(ul.Size(), 0u);
  ASSERT_EQUAL(ul.Capacity(), 32u);
  ...
  StackVector<int, 5> z(2);
  ASSERT_EQUAL(z.Size(), 2u);
  ASSERT_EQUAL(z.Capacity(), 5u);
  ASSERT_EQUAL(z.begin() + 2u, z.end());
