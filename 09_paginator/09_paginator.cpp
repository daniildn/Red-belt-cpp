...
public:
	...
	size_t size() const {
		return end_interval - begin_interval;
	}
private:
	Iterator begin_interval, end_interval;
};
...
template<typename Iterator>
Paginator<Iterator> MakePaginator(const Iterator& begin, const Iterator& end,
		size_t page_size) {
...
void TestPageSizes() {
	...
	auto letters_pagination = MakePaginator(letters.begin(), letters.end(), 11);
...
void TestPagePagination() {
	...
	const vector<vector<int>> expected = { { 1, 2, 3, 4 }, { 5, 6, 7, 8 },
